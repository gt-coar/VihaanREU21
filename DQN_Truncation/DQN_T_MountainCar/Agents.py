...
class AgentT1():
    ...
    def learn(self, experiences, gamma):
        ...
        for param in self.qnetwork_local.parameters():
            param.grad.data.clamp_(-TRUNCATION_LIM1, TRUNCATION_LIM1)
...
class AgentT2():
    ...
    def learn(self, experiences, gamma):
        ...
        """ +T TRUNCATION PRESENT """
        for param in self.qnetwork_local.parameters():
            param.grad.data.clamp_(-TRUNCATION_LIM2, TRUNCATION_LIM2)
...
class AgentT3():
    ...
    def learn(self, experiences, gamma):
        ...
        """ +T TRUNCATION PRESENT """
        for param in self.qnetwork_local.parameters():
            param.grad.data.clamp_(-TRUNCATION_LIM3, TRUNCATION_LIM3)
