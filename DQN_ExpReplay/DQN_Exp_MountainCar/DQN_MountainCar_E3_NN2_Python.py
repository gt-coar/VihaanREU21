...
from QNetworks import QNetwork1,QNetwork2
...
for i in range(no_siblings):
    ...
    agent = AgentE3_NN2(state_size=state_shape,action_size = action_shape,seed = 0)
    [temp_scores,sibling_lives[i]] = dqn()
    sibling_scores.append(temp_scores)
time_taken = datetime.datetime.now() - begin_time
# Saving the files

hkl.dump([sibling_lives,sibling_scores,time_taken],'Data_MountainCar_E3_NN2')
